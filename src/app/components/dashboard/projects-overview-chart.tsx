...
function ProjectsOverviewChart({ data, years }: ProjectsOverviewChartProps) {
  // Memoize the bar elements since data and years typically don't change frequently.
  const bars = useMemo(() => {
    ...
    <div className="bg-slate-900/60 backdrop-blur-md rounded-xl border border-slate-800 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.3)] relative overflow-hidden group">
      ...
      <h2 className="text-lg font-semibold mb-4 flex justify-between">
        ...
        <span className="text-xs text-slate-400">
          Project status distribution per years
        </span>
      </h2>
...
export default React.memo(ProjectsOverviewChart)
