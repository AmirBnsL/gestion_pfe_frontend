...
export function ProjectSettings({
  ...
  const supervisor = team.project?.supervisor || projectData.supervisor;
  const teamMembers = team.members || projectData.teamMembers;

  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      {/* Project Details Card */}
      <Card className="col-span-1 lg:col-span-2 bg-slate-900/50 border border-slate-800 backdrop-blur-sm shadow-lg"></Card>
        ...
        <CardContent className="p-6">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-4">
                <Avatar className="h-12 w-12 border-2 border-purple-500/50">
                  ...
                  <img src={supervisor.avatarUrl || "/placeholder.svg"} alt={supervisor.name || "Supervisor"} />
                </Avatar>
                <div>
                  <p className="font-medium text-slate-200">{supervisor.name || "Unknown"}</p>
                  <p className="text-sm text-slate-400">{supervisor.specialization || "Supervisor"}</p>
                </div>
              </div>
              <Button
                variant="outline"
            ...
            <div className="pt-4 border-t border-slate-800">
              ...
              <TeamMembersList members={teamMembers} students={students} joinRequests={joinRequests} />
            </div>
          </div>
        </CardContent>
      </Card>
